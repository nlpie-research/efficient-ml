...
datasets = [
    DatasetInfo("/mnt/sdd/niallt/bio-lm/data/tasks/I2B22010NER_preprocessed", #Use the pre-processing code in BioLM (https://github.com/facebookresearch/bio-lm)
                metric="f1",
...
models = [
  ModelInfo("/mnt/sdc/niallt/saved_models/lightweight/", "bert-base-uncased")
]
