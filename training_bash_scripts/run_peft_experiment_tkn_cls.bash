...
peft_methods=(Full) # PREFIX_TUNING LORA PROMPT_TUNING
tasks=(i2b2-2010-NER i2b2-2012-NER i2b2-2014-NER) # i2b2-2010-NER 
max_epochs=5
gpu=0
log_save_dir=/mnt/sdd/efficient_ml_data/saved_models/peft/frozen_llm/logs
ckpt_save_dir=/mnt/sdd/efficient_ml_data/saved_models/peft/frozen_llm/ckpts
for task in "${tasks[@]}"
    do
