...
if [ "$analysis_number" -eq 2 ]; then
    ...
    max_epochs=5
    time_budget=(2000)
elif [ "$analysis_number" -eq 4 ]; then
...
gpu=$analysis_number
log_save_dir=/mnt/sdh/effecient_ml/tb_2000_default_params/logs
ckpt_save_dir=/mnt/sdh/effecient_ml/tb_2000_default_params/ckpts
