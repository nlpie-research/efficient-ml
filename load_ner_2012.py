...
load_ner_dataset("I2B22012NER/train.txt.conll", "train")
load_ner_dataset("I2B22012NER/dev.txt.conll", "validation")
load_ner_dataset("I2B22012NER/test.txt.conll", "test")
...
dataset.save_to_disk("i2b2-2012/")
